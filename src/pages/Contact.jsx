            ...
            <div className="w-full max-w-3xl space-y-6">
                ...
                <div className="animate-fade-in-up">
                    <h1 className="text-3xl md:text-4xl font-bold flex items-center gap-2">
                        <span className="text-vscode-accent">06.</span> Contact Me
                    </h1>
                    <p className="text-vscode-muted mt-2">Get in touch via the terminal below</p>
                </div>

                <div className="bg-vscode-bg border border-vscode-border rounded-lg shadow-2xl overflow-hidden animate-fade-in-up">
